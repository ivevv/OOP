...
class TInterface(QWidget):
    def setupUi(self, Application):
        ...
        self.roots.setGeometry(QtCore.QRect(20, 160, 91, 41))
        self.roots.setObjectName("roots")
        self.x1_label = QtWidgets.QLabel(Application)
        self.x1_label.setGeometry(QtCore.QRect(20, 200, 55, 51))
        self.x1_label.setObjectName("x1_label")
        self.x2_label = QtWidgets.QLabel(Application)
        self.x2_label.setGeometry(QtCore.QRect(20, 260, 55, 31))
        ...
        self.x1.setGeometry(QtCore.QRect(80, 200, 621, 51))
        self.x1.setText("")
        self.x1.setObjectName("x1")
        self.x2 = QtWidgets.QLabel(Application)  # поле вывода второго корня
        self.x2.setGeometry(QtCore.QRect(80, 250, 621, 51))
        self.x2.setText("")
